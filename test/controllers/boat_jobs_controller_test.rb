...
class BoatJobsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat_job" do
    assert_difference('BoatJob.count') do
      post boat_jobs_url, params: { boat_job: { boats_id: @boat_job.boats_id, jobs_id: @boat_job.jobs_id } }
    end
  ...
  test "should update boat_job" do
    patch boat_job_url(@boat_job), params: { boat_job: { boats_id: @boat_job.boats_id, jobs_id: @boat_job.jobs_id } }
